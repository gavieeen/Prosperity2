...
class Graph:
    ...
    def build_graph(self, rates_matrix):
    ...
    def Display_Graph(self, path, profit, flag):
        ...
        nx.draw_networkx_labels(
            graph_view, pos, labels, font_size=16, font_color="black"
        )
...
if __name__ == "__main__":
    ...
    print("Enter the index of the starting currency (0 to {}): ".format(numV - 1))
    start_currency = int(input())

    g = Graph(numV, tickers)
    g.Bellman_Ford(rates_matrix, start_currency)
